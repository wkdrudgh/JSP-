...
마치며
------
JSP를 이용해서 많은 기능을 넣고 싶었지만 거의 기본적이고 CRUD를 익히기 위해 해본 프로젝트여서 많은 아쉬움이 남았습니다.
다음에는 외부라이브러리도 사용해보고 검색기능이랑 게시글을 삭제하고 다시 작성했을 때 고유번호를 부여하는 거라 삭제한 번호가 아예사라지는 점을 해결 못해서 해결해보고 싶습니다.
그리고 부트스트랩을 많이 다뤄보고 이용해서 디자인도 더 꾸며보고 싶고 너무 해보고 싶은게 많았지만 제가 할 수 있는 선에서 최선을 다해 구현을 했습니다. 
